...
library(xtable)
filelist=c("../fastqfiles/Base1.fastq","../fastqfiles/Low1.fastq","../fastqfiles/High1.fastq");
labellist=c("base","low","high");
reads=c(688,1730,703);
mappedreads=c(688,1730,703);
totalsgrnas=c(25,25,25);
zerocounts=c(0,4,7);
giniindex=c(0.10614731367766927,0.3942923307396725,0.5440737135650393);
...
genboxplot("results-paired.count_normalized.txt");
@
...
genhistplot("results-paired.count_normalized.txt");
@
...
genpcaplot("results-paired.count_normalized.txt");
@
...
<<fig=TRUE,echo=FALSE,width=4.7,height=4.7>>=
genclustering("results-paired.count_normalized.txt");
@
