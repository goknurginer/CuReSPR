...
library(xtable)
filelist=c("../fastqs/Base1.fastq","../fastqs/Low1.fastq","../fastqs/Low2.fastq","../fastqs/High1.fastq","../fastqs/High2.fastq");
labellist=c("base","low","low","high","high");
reads=c(688,1730,2001,703,659);
mappedreads=c(688,1730,2001,703,659);
totalsgrnas=c(25,25,25,25,25);
zerocounts=c(0,4,4,7,8);
giniindex=c(0.10614731367766927,0.3942923307396725,0.4063268595111277,0.5440737135650393,0.5635822476129941);
...
genboxplot("results.count_normalized.txt");
@
...
genhistplot("results.count_normalized.txt");
@
...
genpcaplot("results.count_normalized.txt");
@
...
<<fig=TRUE,echo=FALSE,width=5.1,height=5.1>>=
genclustering("results.count_normalized.txt");
@
