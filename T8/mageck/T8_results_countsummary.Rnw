...
library(xtable)
filelist=c("../fastqs/T0-Control.fastq.gz","../fastqs/T8-Vehicle.fastq.gz","../fastqs/T8-APR-246.fastq.gz");
labellist=c("Control","Vehicle","T8");
reads=c(213111,184346,187963);
mappedreads=c(134151,116540,114090);
totalsgrnas=c(77441,77441,77441);
zerocounts=c(21619,27232,28274);
giniindex=c(0.4241260099203754,0.48284872370876997,0.4939629426480724);
...
<<fig=TRUE,echo=FALSE,width=4.7,height=4.5>>=
genboxplot("T8_results.count_normalized.txt");
@

The following figure shows the histogram of median-normalized read counts in all samples.


<<fig=TRUE,echo=FALSE,width=4.7,height=4.7>>=
genhistplot("T8_results.count_normalized.txt");
@
...
<<fig=TRUE,echo=FALSE,width=6.7,height=4.7>>=
genpcaplot("T8_results.count_normalized.txt");
@
...
<<fig=TRUE,echo=FALSE,width=4.7,height=4.7>>=
genclustering("T8_results.count_normalized.txt");
@
